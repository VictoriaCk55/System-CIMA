        ...
        <div class="card-body">
            <form action="{{ route('clientes.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-4">
                        ...
                        <textarea class="form-control @error('direccion') is-invalid @enderror" 
                                  ...
                                  name="direccion" 
                                  rows="3" 
                                  placeholder="Ej: Av. Blanco Galindo KM 5, Cochabamba">{{ old('direccion') }}</textarea>
                        @error('direccion')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="d-flex justify-content-between pt-3 border-top">
                    <a href="{{ route('clientes.index') }}" class="btn btn-secondary" style="border-radius: 30px; padding: 10px 25px;">
